...
export const partners: Partner[] = [
  {
    ...
    descriptionZh: "专业从事住宅和商用家具制造超过15年。凯迪斐洛拥有20,000平方米的生产设施，配备先进的CNC设备和专职研发团队。其沙发和床系列产品出口至欧洲、北美和中东等30多个国家。",
    descriptionEs: "Especializada en la fabricación de muebles residenciales y comerciales durante más de 15 años. Kaidi Feiluo opera una instalación de producción de 20.000 m² con maquinaria CNC avanzada y un equipo dedicado de I+D. Sus colecciones de sofás y camas se exportan a más de 30 países en Europa, Norteamérica y Oriente Medio.",
    location: "Linyi, Shandong, China",
    locationZh: "中国山东临沂",
    locationEs: "Linyi, Shandong, China",
    specialties: ["Sofas", "Beds", "Cabinets", "Custom Upholstery"],
    specialtiesZh: ["沙发", "床", "柜子", "定制软包"],
    specialtiesEs: ["Sofás", "Camas", "Armarios", "Tapicería Personalizada"],
    yearFounded: 2010,
