...
export const partners: Partner[] = [
  ...
  },
  {
    ...
    nameZh: "盛瀚实业",
    nameEs: "Shenghan Industrial",
    descriptionZh: "盛瀚实业经营工业清洁产品、特种化学品和综合商品。作为母公司，我们为全球买家采购、质检并出口各类工业消耗品。",
    descriptionEs: "Shenghan Industrial maneja productos de limpieza industrial, productos químicos especializados y mercancía general. Como empresa matriz, obtenemos, verificamos la calidad y exportamos una amplia gama de consumibles industriales para compradores globales.",
    locationZh: "中国山东临沂",
    locationEs: "Linyi, Shandong, China",
    specialtiesZh: ["工业清洁剂", "化学品", "综合商品"],
    specialtiesEs: ["Limpiadores Industriales", "Productos Químicos", "Mercancía General"],
    description:
      "Shenghan Industrial handles industrial cleaning products, specialty chemicals, and general merchandise. As the parent trading company, we source, quality-check, and export a wide range of industrial consumables for global buyers.",
    location: "Linyi, Shandong, China",
