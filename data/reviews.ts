...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    productName: "盛煜 SG-9000 硅酮结构密封胶",
    rating: 5,
    comment: "对比了6个品牌最终选了盛煜。SG-9000在紫外老化测试中远超竞品，售后技术团队24小时内就发了完整的测试报告和施工指南，非常专业。",
    lang: "zh",
    date: "2026-04-28",
  ...
  },
  {
    ...
    productName: "Shengyu LED High Bay Light LT-200",
    rating: 4,
  ...
  // === 英文评价 ===
  {
    ...
    productName: "Shengyu Heavy-Duty Anchor Fastener Kit HW-500",
    rating: 5,
  ...
  // === 西班牙语评价 ===
  {
    ...
    productName: "Shengyu Sofá 05",
    rating: 5,
    comment: "Pedimos 20 unidades para la renovación del lobby de nuestro hotel. La calidad superó las expectativas — la tapicería y la estructura son muy sólidas. El envío llegó bien embalado, cero daños. Tercer pedido con Shengyu y definitivamente no será el último.",
    lang: "es",
    date: "2026-05-25",
  ...
  },
  {
    ...
    productName: "Shengyu Industrial Desengrasante Multiuso CC-300",
    rating: 4,
